    ...
    <div ref={ref}
      ...
      id="portfolio">
        <div className='flex-1 text-white p-10'>
            ...
            <p className="text-center font-normal text-xl">some of the projects I&apos;ve worked on</p>
        </div>
        ...
        <div className="grid gap-4 px-6">
            <div className={`flex justify-around p-4 mb-4 ${isAnimating ? 'animate-bounce' : ''}`}>
                ...
                <div className="max-w-[450px] h-[300px] text-white overflow-hidden">
                    <h3 className="text-2xl font-bold">Project Name: {activePortfolio.name}</h3>
                    <h4 className="mb-4 mt-2 font-semibold">Tools / Stack : {activePortfolio.tools}</h4>
