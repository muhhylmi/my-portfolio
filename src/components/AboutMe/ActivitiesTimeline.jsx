            ...
            {data.map((school, index) => (
                <li key={index} className="relative mb-6 sm:mb-0">
                    ...
                    <div className="mt-3 sm:pe-8">
                        ...
                        <time className="block mt-1 mb-2 text-sm font-semibold leading-none text-pink-600 italic">{school.year}</time>
                        <p className="text-base font-normal text-white">{school.description}</p>
                    </div>
                </li>
            ))}
        </ol>
