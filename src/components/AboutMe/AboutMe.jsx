    ...
    >
      <div className="flex-1 text-white p-10">
        ...
        <p className="text-center font-normal text-xl">
          ...
          strong commitment to continuous learning and a determination to grasp
          complex concepts. Skilled in creating RESTful APIs, database
          management, and know the basics of cloud services integration and
          adept at managing HTTP requests and utilizing message brokers.
        </p>
      </div>
